...
class FormKendaraanSelesaiBongkar extends StatefulWidget {
  final Kendaraan kendaraan;

  final Function refreshListCallback;
  const FormKendaraanSelesaiBongkar(
      {super.key, required this.kendaraan, required this.refreshListCallback});

  @override
  State<FormKendaraanSelesaiBongkar> createState() =>
      _FormKendaraanSelesaiBongkarState();
}

class _FormKendaraanSelesaiBongkarState
    extends State<FormKendaraanSelesaiBongkar> {
  final _formKey = GlobalKey<FormState>();
  XFile? _image;
  final ImagePicker _picker = ImagePicker();
  bool _isUploading = false;

  String apiUrl = 'https://satukomando.id/api-prod/kendaraan/selesaibongkar';
    ...
    try {
      if (_image != null) {
        final request = http.MultipartRequest(
            'PUT', Uri.parse(apiUrl + "/" + widget.kendaraan.uuid));
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Form Isian Kendaraan Selesai Bongkar'),
        centerTitle: true,
      ),
      body: Padding(
              ...
              children: [
                ...
                */
                ...
                ElevatedButton(
                  ...
                  child: Text('Ambil Photo Selesai Bongkar'),
                ),
                TextFormField(
                  //controller: _namaController,
                  initialValue: widget.kendaraan.noPolisi,
                  readOnly: true,
