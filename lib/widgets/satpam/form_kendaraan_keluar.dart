...
class FormKendaraanKeluar extends StatefulWidget {
  final Kendaraan kendaraan;

  final Function refreshListCallback;
  const FormKendaraanKeluar(
      {super.key, required this.kendaraan, required this.refreshListCallback});

  @override
  State<FormKendaraanKeluar> createState() => _FormKendaraanKeluarState();
}

class _FormKendaraanKeluarState extends State<FormKendaraanKeluar> {
  final _formKey = GlobalKey<FormState>();
  XFile? _image;
  final ImagePicker _picker = ImagePicker();
  bool _isUploading = false;

  String apiUrl = 'https://satukomando.id/api-prod/kendaraan/keluar';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Form Isian Kendaraan Keluar'),
        centerTitle: true,
      ),
      body: Padding(
