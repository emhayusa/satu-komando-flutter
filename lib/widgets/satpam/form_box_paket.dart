...
class FormBoxPaket extends StatefulWidget {
  final CekBoxModel box;

  final Function refreshListCallback;
  const FormBoxPaket(
      {super.key, required this.box, required this.refreshListCallback});

  @override
  State<FormBoxPaket> createState() => _FormBoxPaketState();
}

class _FormBoxPaketState extends State<FormBoxPaket> {
  final _formKey = GlobalKey<FormState>();
  XFile? _image;
  final ImagePicker _picker = ImagePicker();
  bool _isUploading = false;

  String apiUrl = 'https://satukomando.id/api-prod/cek-box/paket';
    ...
    try {
      if (_image != null) {
        final request = http.MultipartRequest(
            'PUT', Uri.parse(apiUrl + "/" + widget.box.uuid));
