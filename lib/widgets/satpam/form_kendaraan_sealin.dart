...
class FormKendaraanSealIn extends StatefulWidget {
  final Kendaraan kendaraan;

  final Function refreshListCallback;
  const FormKendaraanSealIn(
      {super.key, required this.kendaraan, required this.refreshListCallback});

  @override
  State<FormKendaraanSealIn> createState() => _FormKendaraanSealInState();
}

class _FormKendaraanSealInState extends State<FormKendaraanSealIn> {
  final _formKey = GlobalKey<FormState>();
  XFile? _image;
  final ImagePicker _picker = ImagePicker();
  bool _isUploading = false;

  String apiUrl = 'https://satukomando.id/api-prod/kendaraan/sealin';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Form Isian Kendaraan Seal In'),
        centerTitle: true,
      ),
      body: Padding(
              ...
              children: [
                ...
                */
                ...
                ElevatedButton(
                  ...
                  child: Text('Ambil Photo Seal In'),
                ),
                TextFormField(
