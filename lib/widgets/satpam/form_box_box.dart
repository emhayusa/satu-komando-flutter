...
class FormBoxBox extends StatefulWidget {
  ...
  @override
  State<FormBoxBox> createState() => _FormBoxBoxState();
}

class _FormBoxBoxState extends State<FormBoxBox> {
  final _formKey = GlobalKey<FormState>();
  XFile? _image;
  final ImagePicker _picker = ImagePicker();
  bool _isUploading = false;

  String apiUrl = 'https://satukomando.id/api-prod/cek-box/box';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Form Isian Box'),
        centerTitle: true,
      ),
      body: Padding(
              ...
              children: [
                ...
                */
                ...
                ElevatedButton(
                  ...
                  child: Text('Ambil Photo Isi Box'),
                ),
