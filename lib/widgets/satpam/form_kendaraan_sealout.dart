...
class FormKendaraanSealOut extends StatefulWidget {
  final Kendaraan kendaraan;

  final Function refreshListCallback;
  const FormKendaraanSealOut(
      {super.key, required this.kendaraan, required this.refreshListCallback});

  @override
  State<FormKendaraanSealOut> createState() => _FormKendaraanSealOutState();
}

class _FormKendaraanSealOutState extends State<FormKendaraanSealOut> {
  final _formKey = GlobalKey<FormState>();
  XFile? _image;
  final ImagePicker _picker = ImagePicker();
  bool _isUploading = false;

  String apiUrl = 'https://satukomando.id/api-prod/kendaraan/sealout';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Form Isian Kendaraan Seal Out'),
        centerTitle: true,
      ),
      body: Padding(
              ...
              children: [
                ...
                */
                ...
                ElevatedButton(
                  ...
                  child: Text('Ambil Photo Seal Out'),
                ),
                TextFormField(
