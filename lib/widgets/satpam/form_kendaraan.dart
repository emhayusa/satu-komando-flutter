...
class _FormKendaraanState extends State<FormKendaraan> {
  ...
  TextEditingController _totalTOController = TextEditingController();
  TextEditingController _totalParcelController = TextEditingController();
    ...
    try {
      if (_image != null) {
        ...
        request.fields['data'] = '{"description":"' +
            ...
            '","totalTO":"' +
            _totalTOController.text +
            '","totalParcel":"' +
            _totalParcelController.text +
            '","warehouseType":' +
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Form Isian Kendaraan'),
        centerTitle: true,
      ),
      body: Padding(
          ...
          child: Form(
            ...
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 10),
                TextFormField(
                  controller: _totalParcelController,
                  //maxLines: 4,
                  decoration: InputDecoration(
