...
class FormBoxKeluar extends StatefulWidget {
  ...
  @override
  State<FormBoxKeluar> createState() => _FormBoxKeluarState();
}

class _FormBoxKeluarState extends State<FormBoxKeluar> {
  final _formKey = GlobalKey<FormState>();
  XFile? _image;
  final ImagePicker _picker = ImagePicker();
  bool _isUploading = false;

  String apiUrl = 'https://satukomando.id/api-prod/cek-box/keluar';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Form Isian Box Keluar'),
        centerTitle: true,
      ),
      body: Padding(
