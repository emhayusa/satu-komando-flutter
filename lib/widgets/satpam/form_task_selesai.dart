...
class FormTaskSelesai extends StatefulWidget {
  final CekTaskModel task;

  final Function refreshListCallback;
  const FormTaskSelesai(
      {super.key, required this.task, required this.refreshListCallback});

  @override
  State<FormTaskSelesai> createState() => _FormTaskSelesaiState();
}

class _FormTaskSelesaiState extends State<FormTaskSelesai> {
  final _formKey = GlobalKey<FormState>();
  XFile? _image;
  final ImagePicker _picker = ImagePicker();
  bool _isUploading = false;

  String apiUrl = 'https://satukomando.id/api-prod/cek-task/selesai';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Form Isian Task Selesai'),
        centerTitle: true,
      ),
      body: Padding(
              ...
              children: [
                ...
                */
                ...
                ElevatedButton(
                  ...
                  child: Text('Ambil Photo Selesai'),
                ),
                TextFormField(
                  controller: _noSealInController,
                  decoration: const InputDecoration(
                    labelText: 'Jumlah Cek',
                  ),
                  validator: (value) {
                    if (value!.isEmpty) {
                      return 'Masukkan Jumlah Cek';
                    }
                    return null;
                  },
                ),
