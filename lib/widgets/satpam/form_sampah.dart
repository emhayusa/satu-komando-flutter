...
class FormSampah extends StatefulWidget {
  const FormSampah({super.key});

  @override
  State<FormSampah> createState() => _FormSampahState();
}

class _FormSampahState extends State<FormSampah> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Form Pengecekan Sampah'),
        centerTitle: true,
      ),
      body: Padding(
