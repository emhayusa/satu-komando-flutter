...
class FormKendaraanBongkar extends StatefulWidget {
  final Kendaraan kendaraan;

  final Function refreshListCallback;
  const FormKendaraanBongkar(
      {super.key, required this.kendaraan, required this.refreshListCallback});

  @override
  State<FormKendaraanBongkar> createState() => _FormKendaraanBongkarState();
}

class _FormKendaraanBongkarState extends State<FormKendaraanBongkar> {
  final _formKey = GlobalKey<FormState>();
  XFile? _image;
  final ImagePicker _picker = ImagePicker();
  bool _isUploading = false;

  String apiUrl = 'https://satukomando.id/api-prod/kendaraan/bongkar';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Form Isian Kendaraan Bongkar'),
        centerTitle: true,
      ),
      body: Padding(
              ...
              children: [
                ...
                */
                ...
                ElevatedButton(
                  ...
                  child: Text('Ambil Photo Bongkar'),
                ),
                TextFormField(
