...
class FormSampahKarung extends StatefulWidget {
  final CekSampahModel sampah;

  final Function refreshListCallback;
  const FormSampahKarung(
      {super.key, required this.sampah, required this.refreshListCallback});

  @override
  State<FormSampahKarung> createState() => _FormSampahKarungState();
}

class _FormSampahKarungState extends State<FormSampahKarung> {
  final _formKey = GlobalKey<FormState>();
  XFile? _image;
  final ImagePicker _picker = ImagePicker();
  bool _isUploading = false;

  String apiUrl = 'https://satukomando.id/api-prod/cek-sampah/karung';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Form Isian Sampah Karung'),
        centerTitle: true,
      ),
      body: Padding(
