...
class FormSampahKeluar extends StatefulWidget {
  final CekSampahModel sampah;

  final Function refreshListCallback;
  const FormSampahKeluar(
      {super.key, required this.sampah, required this.refreshListCallback});

  @override
  State<FormSampahKeluar> createState() => _FormSampahKeluarState();
}

class _FormSampahKeluarState extends State<FormSampahKeluar> {
  final _formKey = GlobalKey<FormState>();
  XFile? _image;
  final ImagePicker _picker = ImagePicker();
  bool _isUploading = false;

  String apiUrl = 'https://satukomando.id/api-prod/cek-sampah/keluar';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Form Isian Sampah Keluar'),
        centerTitle: true,
      ),
      body: Padding(
